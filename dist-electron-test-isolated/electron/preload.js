...
electron_1.contextBridge.exposeInMainWorld('electronAPI', {
    ...
    setDoubaoLlmApiKey: (apiKey) => electron_1.ipcRenderer.invoke('set-doubao-llm-api-key', apiKey),
    setDoubaoEmbeddingModel: (model) => electron_1.ipcRenderer.invoke('set-doubao-embedding-model', model),
    ...
    setDoubaoApiKey: (apiKey) => electron_1.ipcRenderer.invoke('set-doubao-api-key', apiKey),
    ...
    testSavedSttConnection: (provider, region) => electron_1.ipcRenderer.invoke('test-saved-stt-connection', provider, region),
