...
class GeminiEmbeddingProvider {
    ...
    dimensions;
    space;
    constructor(apiKey, model = DEFAULT_MODEL, dimensions = DEFAULT_DIMS) {
        this.apiKey = apiKey;
    ...
    async embedBatch(texts, opts = {}) {
        ...
        return embeddings.map((e, i) => this.validateVector(e?.values, `embedBatch[${i}]`));
    }
    async embedSerial(texts, opts) {
        const out = [];
