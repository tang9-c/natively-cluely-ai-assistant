...
class CredentialsManager {
    ...
    clearAll() {
        ...
        if (fs_1.default.existsSync(credentialsPath)) {
            fs_1.default.unlinkSync(credentialsPath);
        }
    ...
    // =========================================================================
    credentialsFilePath() {
        return path_1.default.join(electron_1.app.getPath('userData'), 'credentials.enc');
    }
    saveCredentials() {
        try {
            fs_1.default.writeFileSync(this.credentialsFilePath(), JSON.stringify(this.credentials, null, 2), 'utf8');
        }
        catch (error) {
