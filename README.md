...
全周期表说明各产品如何参与会议；下表进一步比较具体功能。

| 功能 | **CueUp** | 飞书妙记 / 智能纪要 | 钉钉会议 / AI 听记 | 讯飞听见 / 通义听悟 | 安克 / 讯飞 / PLAUD 硬件 |
| --- | --- | --- | --- | --- | --- |
| **会前背景与资料准备** | 会议模式、个人档案、参考资料、知识源 | 日程与协作文档 | 日程与组织文档 | 非主要用途 | 依赖配套软件 |
| **实时语音转写** | 本地或云端；麦克风与系统音频 | ✅ | ✅ | ✅ 具体能力因产品而异 | ⚠️ 取决于设备与服务 |
| **离线语音转写** | ✅ 本地 SenseVoice | ❌ | ❌ | 云端服务为主 | ⚠️ 部分讯飞型号支持 |
| **会中实时总结** | 提供会中总结辅助 | ✅ AI 视图、要点与图表 | 按版本提供 | 按产品提供 | ⚠️ 安克飞书版支持 |
| **会议内容问答** | 当前会议、历史会议与资料检索 | 妙记问答 | AI 问答 | 范围因产品而异 | ⚠️ PLAUD、安克配套服务支持 |
| **按对话节点主动提示回答与追问** | ✅ 模式识别 + 动态卡片 | ❌ | ❌ | ❌ | ❌ |
| **自定义会中辅助模式** | ✅ 提示词、上下文、意图词、参考资料 | ❌ | ❌ | ❌ | ❌ |
| **本地资料引用** | 上传资料、本地索引、回答引用 | 配套平台知识能力 | 配套平台知识能力 | 上传范围因产品而异 | 依赖配套软件 |
| **在会议助手内配置 MCP 企业知识源** | ✅ 服务地址与认证配置 | ❌ | ❌ | ❌ | ❌ |
| **会后摘要与行动项** | ✅ | ✅ | ✅ | ✅ 格式因产品而异 | 通过配套服务提供 |
| **通过自定义 SKILL.md 处理转录** | ✅ 预制及自定义技能 | ❌ | ❌ | ❌ | ❌ |
| **团队协作与任务流转** | 个人使用、导出分享为主 | 文档、评论、任务协作 | 文档、待办、组织协作 | 分享与导出为主 | 安克衔接飞书，其他因服务而异 |
| **便携独立录音** | 需要电脑或音频设备 | 使用手机等设备 | 使用手机等设备 | 使用手机等设备 | **主要优势** |
| **历史会议与知识复用** | 本地会议搜索、资料库、MCP 知识源 | 妙记与组织知识 | 听记与组织文档 | 历史录音与文件 | 录音档案、部分支持 AI 问答 |

*✅ 支持；⚠️ 条件性支持；❌ 本次对比范围内未提供。竞品不支持项依据 CueUp 产品方调研，不包含另行开发的插件或企业定制方案。纪要模板不等同于会中辅助模式。同组产品能力可能不同，具体功能受版本、套餐、设备型号和权限影响。调研口径日期：2026-09-06。*
