...
const EXPLICIT_PATTERNS: Array<{ pattern: RegExp; sourceHint?: BusinessSystemSourceKind }> = [
    ...
    { pattern: /根据\s*Windchill/i, sourceHint: 'plm' },
    { pattern: /查(?:一下|下|询)?\s*Windchill/i, sourceHint: 'plm' },
    { pattern: /用\s*Windchill/i, sourceHint: 'plm' },
    { pattern: /用\s*Windchill\s*确认/i, sourceHint: 'plm' },
    { pattern: /Windchill\s*(?:里|中|内|BOM|ECN|ECO|change|part|document)/i, sourceHint: 'plm' },
