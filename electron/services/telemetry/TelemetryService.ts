...
export type TelemetryEventName =
  ...
  | 'dynamic_action_delivery_attempted'
  | 'dynamic_action_renderer_received'
  | 'dynamic_action_renderer_queued'
  | 'dynamic_action_renderer_rendered'
  | 'dynamic_action_renderer_dropped'
