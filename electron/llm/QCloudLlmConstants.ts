...
export const QCLOUD_MEETING_TITLE_OUTPUT_TOKENS = 64;
export const QCLOUD_MEETING_SUMMARY_OUTPUT_TOKENS = 4_096;
export const QCLOUD_MEETING_SUMMARY_ENHANCEMENT_OUTPUT_TOKENS = 2_048;
export const QCLOUD_TRANSCRIPT_SKILL_DIRECT_INPUT_TOKENS = 12_000;
export const QCLOUD_TRANSCRIPT_SKILL_CHUNK_INPUT_TOKENS = 12_000;
export const QCLOUD_TRANSCRIPT_SKILL_MAP_OUTPUT_TOKENS = 800;
export const QCLOUD_TRANSCRIPT_SKILL_OUTPUT_TOKENS = 6_144;
export const QCLOUD_TRANSCRIPT_SKILL_MAP_CONCURRENCY = 2;
export const QCLOUD_TRANSCRIPT_SKILL_TIMEOUT_MS = 120_000;
