...
export const NON_SALES_INDUSTRIAL_ISOLATION_FIXTURES = [
  ...
  { modeTemplateType: 'recruiting', utterance: '候选人说做过 PLM 和 QMS 集成项目，能不能追问一个具体例子？', expectedIntent: 'request_example', expectedAction: null, mustNotAction: 'discovery_question', notes: 'recruiting example probe is paused' },
