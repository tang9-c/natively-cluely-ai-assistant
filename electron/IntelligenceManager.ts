...
export class IntelligenceManager extends EventEmitter {
    ...
    async runWhatShouldISay(question?: string, confidence?: number, imagePaths?: string[], options?: { skipCooldown?: boolean; screenContext?: ScreenContext; promptInstruction?: string; persist?: boolean; source?: string; activeSkill?: { id: string; name: string; promptBlock: string } }): Promise<string | null> {
