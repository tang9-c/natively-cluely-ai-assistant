...
interface ElectronAPI {
  ...
  speakerVerificationGetHealth: (options?: { smokeTest?: boolean }) => Promise<import('../src/types/electron').SpeakerVerificationHealth>;
...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  skillsGetSettings: () => ipcRenderer.invoke('skills:get-settings'),
  skillsSetSettings: (settings) => ipcRenderer.invoke('skills:set-settings', settings),
  ...
  setNativelyApiKey: (apiKey: string, options?: { selectAsDefault?: boolean }) => ipcRenderer.invoke('set-natively-api-key', apiKey, options),
  ...
  speakerVerificationGetHealth: (options?: { smokeTest?: boolean }) => ipcRenderer.invoke('speaker-verification:get-health', options),
