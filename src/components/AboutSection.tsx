            ...
            <div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-bg-item-surface rounded-xl p-5">
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="flex items-center gap-4 pl-[60px]">
                                <a
                                    href="https://github.com/tang9-c/natively-cluely-ai-assistant"
                                    onClick={(e) => handleOpenLink(e, "https://github.com/tang9-c/natively-cluely-ai-assistant")}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <a
                            href="https://github.com/tang9-c/natively-cluely-ai-assistant/issues"
                            onClick={(e) => handleOpenLink(e, "https://github.com/tang9-c/natively-cluely-ai-assistant/issues")}
                            className="bg-bg-item-surface border border-border-subtle rounded-xl p-5 transition-all group flex items-center gap-4 h-full hover:bg-white/10"
                        >
