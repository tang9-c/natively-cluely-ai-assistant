...
const PROMPTS = [
  '今天的会议我们会依次讨论产品目标、技术方案、交付时间和团队分工，并确认接下来最重要的行动计划。我会用平时说话的音量，说明每个议题的重点、风险以及需要继续跟进的事项。',
  '客户最近重点关注系统稳定性、数据安全、部署方式和使用体验，我们需要逐项回应并记录后续安排。我会结合使用场景，说明客户当前最关心的问题、我们的判断以及下一步沟通计划。',
  '请用平时说话的方式，介绍你最近正在处理的一件事情，包括遇到的问题、你的判断以及下一步准备怎么做。可以继续说明事情的背景、参与人员、进展，以及你希望最终取得什么结果。',
] as const;
