...
export interface ElectronAPI {
  ...
  onAudioCaptureFailed: (callback: (payload: { channel: 'system' | 'mic'; message: string; attempt: number; maxAttempts: number; backend?: string; terminal?: boolean; stuck?: boolean }) => void) => () => void
